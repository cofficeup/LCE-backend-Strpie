...
CREATE TABLE `lce_payment` (
  ...
  `deleted` varchar(3) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'No',
...
CREATE TABLE `lce_pickup_zones` (
  `id` int NOT NULL AUTO_INCREMENT,
  `zip` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `area` varchar(3) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `drivers` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `order` smallint DEFAULT NULL,
  `geometry` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `geo_location` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `lce_prices` (
  ...
  `sku` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `lce_prices_lists` (
  `id` int NOT NULL AUTO_INCREMENT,
  `type` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 're',
  `name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `lce_processing_sites` (
  ...
  `phone_1` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `phone_2` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `address_1` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `address_2` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `city` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `country` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'US',
  `zip` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `area` varchar(3) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `print_align` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `lce_user_cs` (
  ...
  `status` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'open',
...
CREATE TABLE `lce_user_info` (
  ...
  `user_id` int DEFAULT NULL,
  `user_md` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `phone_1` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `phone_2` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `phone_3` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `cell_phone_1` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `opt_in` varchar(3) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'No',
  `opt_in_log` varchar(5000) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `address_1` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `address_2` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `city` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `country` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'US',
  `nearest_cross_street` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `geo_address` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `geo_lat` float(10,6) DEFAULT NULL,
  `geo_lng` float(10,6) DEFAULT NULL,
  `payment_type` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `payment_cc_number` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `payment_cc_edate_month` varchar(4) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `payment_cc_edate_year` varchar(4) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `customerProfileId` int DEFAULT NULL,
  `customerPaymentProfileId` int DEFAULT NULL,
  `payment_phone` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `payment_address_1` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `payment_address_2` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `payment_city` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `payment_state` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `payment_zip` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `payment_country` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'US',
  `driver_instructions` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `driver_instructions_mdate` datetime DEFAULT NULL,
  `driver_comments` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `driver_comments_mdate` datetime DEFAULT NULL,
  `laundry_instructions` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `laundry_instructions_mdate` datetime DEFAULT NULL,
  `attendant_comments` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `attendant_comments_mdate` datetime DEFAULT NULL,
  `laundry_pref_detergent` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `laundry_pref_softener` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `laundry_pref_bleach` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `laundry_pref_hanging` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `laundry_pref_starch` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `laundry_pref_shirts` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `price_list_id` int NOT NULL DEFAULT '1',
  `pd_upcharge` float DEFAULT NULL,
  `nolaundry_charge` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `asd_monday` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `asd_tuesday` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `asd_wednesday` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `asd_thursday` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `asd_friday` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `asd_saturday` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `asd_sunday` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `hold_date` datetime DEFAULT NULL,
  `suspention_date` datetime DEFAULT NULL,
  `suspention_note` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci,
  `trust_level` int DEFAULT '0',
  `hear_about` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `email_invoice_on_delivery` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'No',
  `wash_fold_instructions` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `customer_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=7889 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Customer Information, BT = BillTo and ST = ShipTo';
...
CREATE TABLE `lce_user_invoice` (
  ...
  `promocode` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=156934 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
) ENGINE=InnoDB AUTO_INCREMENT=249795 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `lce_user_pickup` (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int DEFAULT NULL,
  `pickup_type` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `pickup_date` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `status` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'pickup',
  ...
  `hold_status` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `wf_slip_number` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `dc_items` int DEFAULT NULL,
  `dc_bags_items` int DEFAULT NULL,
  `dc_hanger_items` int DEFAULT NULL,
  `dc_site_id` int DEFAULT NULL,
  `dc_slip_number` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `invoice_id` int DEFAULT NULL,
  ...
  `geo_location` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  ...
  `log` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci,
  `cuser_id` int DEFAULT NULL,
  `cdate` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_user_id` (`user_id`) USING BTREE,
...
) ENGINE=InnoDB AUTO_INCREMENT=213921 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `lce_user_promocodes` (
  ...
  `promocode_name` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `used_date` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `cdate` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `lce_user_rs` (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int DEFAULT NULL,
  `day_monday` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `day_tuesday` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `day_wednesday` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `day_thursday` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `day_friday` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `day_saturday` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `day_sunday` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `delivey_type` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `comments` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci,
  `start_date` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7956 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `lce_waiting_list` (
  `id` int NOT NULL AUTO_INCREMENT,
  `zip` char(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0',
  `notify_email` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `notified` enum('0','1') CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '0',
  `notify_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `notify_email` (`notify_email`) USING BTREE,
  KEY `zip` (`zip`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10097 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
